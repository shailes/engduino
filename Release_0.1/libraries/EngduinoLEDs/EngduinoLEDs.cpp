...
* \param LEDidx     LED index, ranging from 0 (for LED1) to 15 (LED16)
...
* \param LEDNumber  LED number, ranging from 1 (for LED1) to 16 (LED16)
* \param c          Colour, as chosen from the colour enum
*
...
{	
	_setLED(LEDNumber-1, c, MAX_BRIGHTNESS);
}
...
{	
	_setLED(LEDNumber-1, c, brightness);
}
