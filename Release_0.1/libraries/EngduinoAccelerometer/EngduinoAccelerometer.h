/**
* \defgroup EngduinoAccelerometer Driver for Engduino Accelerometer
* 
...
#ifndef __ENGDUINOACCELEROMETER_H__
#define __ENGDUINOACCELEROMETER_H__
...
extern EngduinoAccelerometerClass EngduinoAccelerometer;
